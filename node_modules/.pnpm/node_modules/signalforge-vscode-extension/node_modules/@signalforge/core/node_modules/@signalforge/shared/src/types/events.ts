...
export type BrowserEventType =
  ...
  | 'copilot_candidate_lookup_query';
...
export type ChatEvidenceClassification =
  | 'contract_input'
...
export type BrowserEvent =
  ...
  | DispatchPhraseDetectedEvent
  | DispatchCandidateCreatedEvent
  | CopilotCandidateCapturedEvent
  | ChatGPTTurnClassifiedEvent
  | CopilotCandidateLookupQueryEvent;
