...
function getDefaultDbPath() {
    ...
    if (configuredPath && configuredPath.trim()) {
        return path_1.default.resolve(configuredPath);
    }
        ...
        if (fs_1.default.existsSync(packageJsonPath)) {
            try {
                ...
                if (packageJson && packageJson.name === 'signalforge-dispatch') {
                    return path_1.default.resolve(currentDir, 'apps/native-host/data/signalforge.db');
                }
            }
            catch {
    ...
    return path_1.default.resolve(__dirname, '../../../../../../apps/native-host/data/signalforge.db');
}
...
function initSchema(db) {
    return new Promise((resolve, reject) => {
        db.exec(schema_1.CHAT_EVENTS_SCHEMA + "\n" + schema_2.PROJECTS_SESSIONS_SCHEMA + "\n" + schema_3.COPILOT_EVIDENCE_SCHEMA, (err) => {
            if (err)
                return reject(err);
            const backfills = [
